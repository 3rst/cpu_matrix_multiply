...
#Please use the padding mentioned in this file when running the code
os.system("make")
for i in range(6,11):
...
os.system("srun main dgemm6_ijk2 2048 100")
os.system("srun main dgemm6_ikj2 2048 100")
os.system("srun main dgemm6_jik2 2048 100")
os.system("srun main dgemm6_jki2 2048 100")
os.system("srun main dgemm6_kij2 2048 100")
os.system("srun main dgemm6_kji2 2048 100")
for i in range(0,4):
    os.system("gcc main.c -o main -O"+str(i))
    os.system("srun main dgemm7 2048 76")